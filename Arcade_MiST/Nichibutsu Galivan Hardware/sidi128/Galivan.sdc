...
set_output_delay -clock [get_clocks $sdram_clk]  1.000 [get_ports {VGA_*}]
...
set_output_delay -clock [get_clocks $sdram2_clk] -reference_pin [get_ports {SDRAM2_CLK}] -min -0.8 [get_ports {SDRA2M_D* SDRAM2_A* SDRAM2_BA* SDRAM2_n* SDRAM2_CKE}]
